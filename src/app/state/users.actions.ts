...
export const addUserSuccess = createAction('[Users] Add User Success', props<{newUser: User}>());
...
export const editUserSuccess = createAction('[Users] Edit User Success', props<{editedUser: User}>());
